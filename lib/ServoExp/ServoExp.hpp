...
/**
 * @class ServoExp
 * @brief A class that extends the Servo class to provide additional functionality for controlling a servo motor.
 */
class ServoExp : public Servo {
    ...
    public:
        ...
        /**
         * @brief Prints the servo data (minimum angle, maximum angle, target position, tolerance).
         */
        void printData();
